...
**Alle zwoelf sind entschieden (Stand 2026-09-21).** ✅ = gilt. Wo „ENTSCHIEDEN (Kevin)" steht,
hat Kevin abweichend oder ausdruecklich entschieden; die uebrigen hat er als Empfehlung
uebernommen.
...
| **E2** ✅ | Voting-Modus | **ENTSCHIEDEN (Kevin): Mehrfachstimmen.** Jeder haekchen-artig alle Unterkuenfte an, mit denen er leben koennte (Approval Voting). Verhindert einen Gewinner mit 2 von 8 Stimmen. Folge fuer die Umsetzung: die Stimme ist ein Umschalter je Option, nicht eine Auswahl je Person | Verworfen: eine Stimme pro Person (einfacher, aber bei vielen Vorschlaegen unfair) |
